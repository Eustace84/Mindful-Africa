...
const CAROUSEL_TESTIMONIALS = [
  {
    quote:
      "Therapy felt like a luxury I couldn't justify. Finding this community reminded me I'm not weak for needing help.",
    attribution: 'Anonymous, 24',
  },
  {
    quote:
      'For the first time, someone asked me how I was doing and actually waited for the answer.',
    attribution: 'Anonymous, 31',
  },
  {
    quote:
      "I didn't know healing could feel like coming home. This space gave me that.",
...
const SOCIAL_POSTS = [
  {
    platform: 'Instagram',
    text: "It's okay to outgrow rooms that no longer feel safe. Healing is allowed to be quiet.",
    count: '1,284',
  },
  {
    platform: 'Instagram',
...
const BLOG_POSTS = [
  {
    ...
    readTime: '5 min read',
    imgSrc:
      'https://placehold.co/560x315/2D5A3D/A8C4B8?text=Young+professional+at+desk',
  ...
  },
  {
    ...
    readTime: '5 min read',
    imgSrc:
      'https://placehold.co/560x315/4F6F5C/D4DECE?text=Family+conversation+about+mental+health',
  ...
  },
  {
    ...
    readTime: '5 min read',
    imgSrc:
      'https://placehold.co/560x315/3A5547/B8CFC4?text=Person+reflecting+by+window',
  ...
  return (
    <div
      ...
      <div className='flex items-center gap-2'>
        ...
        <span className='text-xs' style={{ color: '#6B8A7A' }}>
          community voices
        </span>
      </div>
    </div>
  ...
  const stats = [
    {
      ...
      to: 4,
      suffix: '',
      label: 'Africans face mental health challenges',
    },
    {
      prefix: '< ',
      from: 1,
      to: 4,
      suffix: '%',
      label: 'Have access to professional care',
    },
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch '>
          {BUILDING_CARDS.map(({ title, body, icon }, index) => (
            <RevealOnScroll key={title} delay={index * 0.1} className='h-full'>
              <motion.article
                className='h-full rounded-xl p-5 border flex flex-col'
                style={{
                  background:
                    'linear-gradient(100deg, #FFFFFF 30%, #F9F4E3 70%)',
                  borderColor: '#D5D1C3',
                }}
                whileHover={{
                  y: -6,
...
function VoicesBanner() {
  ...
  useEffect(() => {
    const timer = setInterval(
      () => setActive((prev) => (prev + 1) % CAROUSEL_TESTIMONIALS.length),
      5000,
    );
        ...
        <RevealOnScroll>
          <div>
            ...
            <p
              ...
              too. Every voice helps soften the silence.
            </p>
              ...
              <article
                ...
                <div className='flex items-center gap-3 mb-3'>
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(145deg, #61AA61 0%, #797143 100%)',
                    }}
                    aria-hidden='true'
                  />
                  <div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span className='text-xs' style={{ color: '#8A9A8E' }}>
                    community voices
                  </span>
                </div>
              </article>
    ...
    return (
      <motion.div
        ...
        <p style={{ fontSize: '15px', color: '#5A7068' }}>
          We've received your {tabLabel} application. We'll be in touch within
          48 hours.
        </p>
      </motion.div>
    );
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4'>
        <div>
          ...
          <input
            ...
            onFocus={(e) => {
              e.target.style.boxShadow = '0 0 0 3px rgba(45,122,95,0.15)';
            }}
            onBlur={(e) => {
            ...
            <RevealOnScroll key={title} delay={index * 0.1}>
              <motion.article
                ...
                <div
                  ...
                  style={{ backgroundColor: '#DCE4E199', color: '#5A7068' }}>
                  {icon}
                </div>
                <h3
                  className='font-heading mb-1 leading-tight'
                  style={{
                    fontFamily: 'Crimson Pro',
                    color: '#1D2825',
                    fontSize: '20px',
...
function DonationWidget() {
  ...
  const amountInKobo =
    showCustom && customAmount
      ...
      : (PRESET_AMOUNTS.find((a) => a.value === selectedAmount)?.naira || 0) *
        100;
  ...
  const handleDonate = () => {
    ...
    initializePayment({
      onSuccess,
      onClose,
      config: { reference: `mindfully_${Date.now()}` },
    });
  };
    ...
    return (
      <motion.div
        ...
        <p style={{ fontSize: '15px', color: '#5A7068', lineHeight: 1.6 }}>
          Your contribution helps build safer mental health support systems
          across Africa. A receipt has been sent to {donorEmail}.
        </p>
        <motion.button
          whileHover={{ scale: 1.03 }}
          whileTap={{ scale: 0.97 }}
      ...
      <div className='grid grid-cols-4 gap-2 mb-3'>
        {PRESET_AMOUNTS.map(({ label, value }) => (
          <motion.button
            ...
            style={{
              backgroundColor:
                selectedAmount === value && !showCustom ? '#2D5A3D' : '#F5F0E8',
              color:
                selectedAmount === value && !showCustom ? 'white' : '#1B3A2D',
              fontSize: '14px',
            }}>
            {label}
          </motion.button>
